    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      {org?.whatsapp_no && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/20"
